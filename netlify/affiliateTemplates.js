// --------------------------------------------
// 🌍 Travel Affiliate Deep-Link Templates (CommonJS)
// Built from verified Paris examples + fallback base links
// --------------------------------------------
...
const affiliateTemplates = {
  ...
  // 🔗 Fallback Example (for any partner not needing a deep link)
  default: {
    name: "Generic Partner",
    base_url: "https://tp.media/r",
    template: "https://{partner}.com/search?query={destination}",
    params: ["partner", "destination"],
  },
};

module.exports = affiliateTemplates;
