...
// ---------------------------------------------------
// Main Netlify handler (single entrypoint)
// ---------------------------------------------------
exports.handler = async (event, context) => {
  // -----------------------
  // Create new data generation batch
  ...
  // -----------------------------
  // Main Handler (continued) - your main logic starts here (we already have the handler)
  // -----------------------------
  // (Main processing logic previously pasted — continue from building partner dataset)
  // Build partner dataset was done earlier in this handler (kept intact)
